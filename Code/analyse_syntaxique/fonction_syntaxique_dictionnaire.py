    ...
    while stack:
        ...
        if top == current_token.analyse_syntaxique():
            ...
            if token_type in ll1_table[top]:
                ...
                print(f"Erreur: Aucun règle pour {top} avec {token_type}, stack = {stack}")
                return False
        else:
            print(f"Erreur: Symbole inattendu {top} {current_token.analyse_syntaxique()}, stack = {stack}")
            return False
