...
expected_tokens = [('NEWLINE', '', 2, 20), ('KEYWORD', 'def', 2, 24), ('IDENTIFIER', 'calcul_complexe', 2, 40), ('PUNCTUATION', '(', 2, 40),
                   ...
                   ('PUNCTUATION', ':', 2, 46), ('NEWLINE', '', 3, 47), ('INDENT', '', 3, 51), ('NEWLINE', '', 4, 86), ('IDENTIFIER', 'somme', 4, 96), 
                   ...
                   ('IDENTIFIER', 'b', 9, 325), ('NEWLINE', '', 10, 343), ('NEWLINE', '', 11, 344), ('NEWLINE', '', 12, 386), ('KEYWORD', 'if', 12, 393), 
                   ...
                   ('NEWLINE', '', 16, 503), ('NEWLINE', '', 17, 504), ('DEDENT', '', 17, 508), ('NEWLINE', '', 18, 532), ('KEYWORD', 'if', 18, 539), 
                   ...
                   ('STRING', '"Un des nombres est positif"', 21, 663), ('PUNCTUATION', ')', 21, 664), ('NEWLINE', '', 22, 665), ('NEWLINE', '', 23, 666),
                   ('DEDENT', '', 23, 670), ('NEWLINE', '', 24, 707), ('IDENTIFIER', 'a', 24, 713), ('OPERATOR_BINARY', '+=', 24, 715), ('NUMBER', '1', 24, 718), 
                   ('NEWLINE', '', 25, 741), ('IDENTIFIER', 'b', 25, 747), ('OPERATOR_BINARY', '-=', 25, 749), ('NUMBER', '1', 25, 752), ('NEWLINE', '', 26, 775), 
                   ('NEWLINE', '', 27, 776), ('NEWLINE', '', 28, 799), ('IDENTIFIER', 'a_gauche', 28, 812), ('OPERATOR_UNARY', '=', 28, 813), ('IDENTIFIER', 'a', 28, 816), 
                   ('OPERATOR_BINARY', '<<', 28, 818), ('NUMBER', '2', 28, 821), ('NEWLINE', '', 29, 842), ('IDENTIFIER', 'b_droite', 29, 855), ('OPERATOR_UNARY', '=', 29, 856),
                   ('IDENTIFIER', 'b', 29, 859), ('OPERATOR_BINARY', '>>', 29, 861), ('NUMBER', '3', 29, 864), ('NEWLINE', '', 30, 885), ('NEWLINE', '', 31, 886), 
                   ...
                   ('NEWLINE', '', 32, 953), ('NEWLINE', '', 33, 954), ('DEDENT', '', 33, 954), ('NEWLINE', '', 34, 976), ('KEYWORD', 'def', 34, 980), 
                   ...
                   ('NEWLINE', '', 38, 1010), ('NEWLINE', '', 39, 1068), ('IDENTIFIER', 'result', 39, 1079), ('OPERATOR_UNARY', '=', 39, 1080), 
                   ('IDENTIFIER', 'calcul_complexe', 39, 1097), ('PUNCTUATION', '(', 39, 1097), ('IDENTIFIER', 'x', 39, 1099), ('PUNCTUATION', ',', 39, 1099), 
                   ('IDENTIFIER', 'y', 39, 1102), ('PUNCTUATION', ')', 39, 1102), ('NEWLINE', '', 40, 1103), ('NEWLINE', '', 41, 1104), ('DEDENT', '', 41, 1104), 
                   ('NEWLINE', '', 42, 1138), ('KEYWORD', 'if', 42, 1141), ('IDENTIFIER', '__name__', 42, 1150), ('OPERATOR_BINARY', '==', 42, 1152), 
